import 'package:cinemates/bloc/get_movie_similar_bloc.dart';
import 'package:cinemates/bloc/get_movies_bloc.dart';
...
class _SimilarMoviesState extends State<SimilarMovies> {
  ...
  Widget _buildMoviesWidget(MovieResponse data) {
    ...
    if (movies.length == 0) {
      return Center(
        child: Container(
          child: Text("Nessun suggerimento", style: TextStyle(
            fontSize: 10.0,
