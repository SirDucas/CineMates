...
import '../widgets/activity_data_table.dart';
...
class ActivityCrudOperatorScreen extends StatefulWidget {
  const ActivityCrudOperatorScreen({Key key}) : super(key: key);

  @override
  _ActivityCrudOperatorScreenState createState() => _ActivityCrudOperatorScreenState();
}

class _ActivityCrudOperatorScreenState extends State<ActivityCrudOperatorScreen> {
                ...
                children: <Widget>[
                  ...
                  Container(
                      ...
                      child: RaisedButton(
                          textColor: Style.Colors.mainColor,
                          color: Style.Colors.secondColor,
                          child: Text('Visualizza Dati Utente'),
                          onPressed: () {
                            Navigator.pushReplacement(context,
                  ...
                  Container(
                      ...
                      child: RaisedButton(
                          textColor: Style.Colors.mainColor,
                          color: Style.Colors.secondColor,
                          child: Text('Aggiorna Dati Attività'),
                          onPressed: () {
                            Navigator.pushReplacement(context,
                                MaterialPageRoute(builder: (context) => ActivityCrudOperatorScreen()));
                          }
