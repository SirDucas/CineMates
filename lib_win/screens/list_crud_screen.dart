...
import '../widgets/list_data_table.dart';
import 'activity_crud_screen.dart';
import 'admin_login_screen.dart';
import 'dashboard_screen.dart';
import 'user_crud_screen.dart';

class ListCrudOperatorScreen extends StatefulWidget {
  const ListCrudOperatorScreen({Key key}) : super(key: key);

  @override
  _ListCrudOperatorScreenState createState() => _ListCrudOperatorScreenState();
}

class _ListCrudOperatorScreenState extends State<ListCrudOperatorScreen> {
                ...
                children: <Widget>[
                  ...
                  Container(
                      ...
                      child: RaisedButton(
                          textColor: Style.Colors.mainColor,
                          color: Style.Colors.secondColor,
                          child: Text('Aggiorna Dati Liste'),
                          onPressed: () {
                            Navigator.pushReplacement(context,
